...
export const getNotificationByUser = createAsyncThunk(
  "notification/by_user",
  async ({ token, page, search, startDate, endDate }, thunkAPI) => {
    try {
      const params = {
        page,
        search,
      ...
      return await notificationService.getNotificationByUser(tokenData, params);
    } catch (error) {
      const message =
...
export const markAllNotiticationAsRead = createAsyncThunk(
