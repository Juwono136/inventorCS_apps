...
export const sendMail = (to, url, emailSubject, titleTxt, emailTxt, btnTxt, res) => {
    let config = {
        service: 'gmail',
        auth: {
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <td align="center" bgcolor="#e9ecef">
                            ...
                            <tr>
                                ...
                                <h1 style="margin: 0; font-size: 24px; font-weight: 700; letter-spacing: -1px; line-height: 48px;">${titleTxt}</h1>
                                </td>
                            </tr>
                            </table>
                        </td>
                        ...
                        <td align="center" bgcolor="#e9ecef">
                            ...
                            <tr>
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                    ...
                                    <td align="center" bgcolor="#ffffff" style="padding: 12px;">
                                        ...
                                        <tr>
                                            <td align="center" bgcolor="#84078d" style="border-radius: 6px;">
                            ...
                            <tr>
                                <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                                <p style="margin: 0;">If the button doesn't work, you can click the following link below:</p>
